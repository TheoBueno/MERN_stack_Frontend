...
<nav className="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div className="container-fluid">
          ...
          <a className="navbar-brand hoverFX" href="#/"><img src="./IMG/Logo - Just Wolves.png" alt="Lobo-Guara Logo" width="35" height="35" className="d-inline-block align-text-center" /> BigBadWolf Bank</a>
